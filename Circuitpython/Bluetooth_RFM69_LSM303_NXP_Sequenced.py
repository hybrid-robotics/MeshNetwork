...
packetLED = DigitalInOut(PIN_PACKET_LED)
packetLED.direction = Direction.OUTPUT
...
while True:
    ...
    if packet is None:
        ...
        sequenceNumberIn = unpack(packet[0:4])
        packet = packet[5:]
        print("Received packet #{0} (raw bytes): '{1}'".format(sequenceNumberIn, packet))
        ...
        sleep(0.2)
        ackPacket = pack(sequenceNumberIn) + "ACK"
